...
public class FirebaseServices {
    ...
    public void UploadImagetoFirebaseStorage(Uri uri,OnCallBack onCallBack){
        StorageReference riverref= FirebaseStorage.getInstance().getReference().child("Chats/Pictures/"+firebaseUser.getUid()+"/"+System.currentTimeMillis()+"."+GetFileExtension(uri));
